...
export default function Listing() {
  ...
  const { data, isLoading, isFetching, isError, error } = useQuery({
    queryKey: ["order-followups", searchParams],
    queryFn: () => orderFollowup.get(searchParams),
    enabled: !!searchParams,
  });

  const deleteMutation = useMutation({
    mutationFn: () => orderFollowup.deleteById(id),
    onSuccess: () => {
      toast({
        title: "Deleted",
      ...
      queryClient.invalidateQueries(["order-followups"]);
    },
    onError: (error) => {
